...
1. two players to play against each other (the players are actually functions)
2. the number of games to play in the match
3. an optional argument to see a log of each game. Set it to True to see these messages.
